...
public class GoldMedalController {
	...
	private CountryMedalsListResponse getCountryMedalsListResponse(
		...
		switch (sortBy) {
			case "year":
				medalsList = goldMedalRepository.findByYear();// TODO: list of medals sorted by year in the given order
				break;
			case "season":
				medalsList = goldMedalRepository.findBySeason();// TODO: list of medals sorted by season in the given order
				break;
			case "city":
				medalsList = goldMedalRepository.findByCity();// TODO: list of medals sorted by city in the given order
				break;
			case "name":
				medalsList = goldMedalRepository.findByName();// TODO: list of medals sorted by athlete's name in the given order
				break;
			case "event":
				medalsList = goldMedalRepository.findByEvent();// TODO: list of medals sorted by event in the given order
				break;
			default:
	...
	private CountryDetailsResponse getCountryDetailsResponse(String countryName) {
		...
		var goldMedalCount = // TODO: get the medal count
				...
				var
		summerWins = // TODO: get the collection of wins at the Summer Olympics, sorted by year in ascending order
